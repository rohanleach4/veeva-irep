...
var path = {
    ...
    devjs : './web/js',
    // Build Paths
    buildbase : './build/'+PresentationName,
    buildassets : './build/'+ PresentationName +'/{slide}/assets',
    buildjs : './build/'+PresentationName+'/{slide}/js',
    // Hidden Presentation Build base
    buildbaseHidden : './build/'+HiddenPresentationName,
    buildassetsHidden : './build/'+ HiddenPresentationName +'/{slide}/assets',
    buildjsHidden : './build/'+HiddenPresentationName+'/{slide}/js'
};
